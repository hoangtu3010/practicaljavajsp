package com.example.practicaljavajsp.util;

import com.example.practicaljavajsp.annotation.Column;
import com.example.practicaljavajsp.annotation.ForeignKey;
...
public class MigrationJava {
    public static final String scanRange = "com.example.practicaljavajsp";
